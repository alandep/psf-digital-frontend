...
export interface TemplateValidationDialogData {
  templateName: string;
  isValid: boolean;
...
@Component({
  selector: 'app-template-validation-dialog',
  standalone: true,
  imports: [
    CommonModule,
    MatDialogModule,
    ...
    <div class="validation-dialog">
      ...
      <mat-dialog-content class="dialog-content">
        ...
        <div class="success-state" *ngIf="!data.errors.length && !data.warnings.length">
          ...
          <p class="success-state__text">Template válido! Nenhum problema encontrado.</p>
        </div>
      </mat-dialog-content>
...
export class TemplateValidationDialogComponent {
  public readonly dialogRef = inject(MatDialogRef<TemplateValidationDialogComponent>);

  private readonly fieldLabels: Record<string, string> = {
    template_name: 'Nome do Template',
    template_code: 'Código',
    contract_text_template: 'Texto do Contrato',
    quantity: 'Quantidade',
    incoterm: 'Incoterm',
    currency: 'Moeda'
  };

  constructor(@Inject(MAT_DIALOG_DATA) public data: TemplateValidationDialogData) {}
  ...
  public get headerTitle(): string {
    ...
    if (this.data.warnings?.length) {
      return 'Template válido com avisos';
    }
