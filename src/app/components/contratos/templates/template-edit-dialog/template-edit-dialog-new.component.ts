...
export class TemplateEditDialogComponent implements OnInit {
  ...
  private goToFirstErrorTab(): void {
    const tabErrors = [
      // Aba 0: Geral
      ['template_name', 'contract_type', 'template_version', 'organization_standard'],
      // Aba 1: Comercial  
      ['commodity', 'quantity_tm', 'base_price', 'incoterm'],
      // Aba 2: Financeiro
  ...
  get quantityControl() { return this.templateForm.get('quantity_tm'); }
  get basePriceControl() { return this.templateForm.get('base_price'); }
